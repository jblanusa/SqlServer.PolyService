...
CREATE TYPE Neo4j
EXTERNAL NAME SSHS.[SqlServer.PolyService.Neo4j];

GO

DECLARE @neo4j AS dbo.Neo4j = N'http://techready-884zg8t4.cloudapp.net:7474/db/data/transaction/commit'
SET @neo4j = @neo4j.SetNamePass('techready','techready')
