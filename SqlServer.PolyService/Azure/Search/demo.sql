...
declare @as dbo.AzureSearch = 'https://techready21.search.windows.net/indexes/articles/docs/index?api-version=2014-07-31-Preview';
set @as = @as.SetApiKey('9DAC191BB26D2149B86C2147708DC7F2');
select * 
FROM OPENJSON(
...
declare @as dbo.AzureSearch = 'https://techready21.search.windows.net/indexes/articles/docs';
set @as = @as.SetApiKey('9DAC191BB26D2149B86C2147708DC7F2');
